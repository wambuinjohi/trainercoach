...
export const BookingModal: React.FC<{ trainer: any, onClose: () => void }> = ({ trainer, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4">
      ...
      <div className="relative w-full max-h-[90vh] overflow-y-auto rounded-none sm:rounded-lg sm:max-w-lg">
        <Card className="rounded-none sm:rounded-lg flex flex-col">
