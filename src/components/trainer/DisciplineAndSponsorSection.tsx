...
export const DisciplineAndSponsorSection: React.FC<DisciplineAndSponsorSectionProps> = ({
  ...
  const [showManualSponsorEntry, setShowManualSponsorEntry] = useState(false)
  ...
  const validateAndSelectSponsorById = async () => {
    ...
    try {
      ...
      setShowManualSponsorEntry(false)
      toast({
        title: 'Success',
  ...
  // ===== SPONSORED REGISTRATION: SHOW SPONSOR SEARCH AND MANUAL ENTRY =====
  return (
    <Card className="border-border">
      <CardHeader className="pb-3">
      ...
      <CardContent className="space-y-6">
        ...
        {/* Sponsor Search & Manual Entry */}
        {!selectedSponsor && (
          <div className="space-y-3">
            {/* Search Tab */}
            {!showManualSponsorEntry && (
              <div className="space-y-3">
                <div>
                ...
                <button
                  type="button"
                  onClick={() => setShowManualSponsorEntry(true)}
            ...
            {/* Manual Sponsor ID Entry Tab */}
            {showManualSponsorEntry && (
              <div className="space-y-3">
                <div>
                  <Label htmlFor="sponsor-id-manual" className="text-sm font-medium">
                    Enter Sponsor ID <span className="text-red-600">*</span>
                  </Label>
                  <p className="text-xs text-muted-foreground mt-1">
