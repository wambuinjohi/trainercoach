...
CREATE TABLE `bookings` (
  ...
  `sessions` JSON NULL COMMENT 'Multi-session booking details: [{date, start_time, end_time, duration_hours}, ...]',
  ...
  `session_phase` VARCHAR(50) NULL COMMENT 'Booking session lifecycle state',
