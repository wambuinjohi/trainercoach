...
ALTER TABLE bookings ADD COLUMN sessions JSON NULL COMMENT 'Multi-session booking details: [{date, start_time, end_time, duration_hours}, ...]' AFTER session_time;
ALTER TABLE bookings ADD COLUMN session_phase VARCHAR(50) NULL COMMENT 'Booking session lifecycle state' AFTER status;
